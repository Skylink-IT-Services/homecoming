...
{
    public class AccomodationRepo:IDataStore<Accomodation>
    {
        ...
        public void Add(Accomodation Params)
        {
            ...
            if (uploaded)
            {
                Accomodation accomodation = new Accomodation()
                {
                    ...
                    CoverPhoto = fileUpLoad.UploadFile(Params.CoverImage),
        ...
        public List<Accomodation> FindAll()
        {
            ...
            return db.Accomodations.AsNoTracking().AsQueryable().Include(o=> o.Business).Include(o => o.AccomodationGallary).ToList();
        }

        public Accomodation GetById(int id)
        {
            return db.Accomodations.Include(o=>o.Business).Include(o=>o.AccomodationGallary).SingleOrDefault(o => o.AccomodationId.Equals(id));
        }
